...
const EditProject = () => {
  return (
      <div className=' bg-slate-100  pt-10 pl-[260px] h-[95vh]'>
           <section
          class="w-[71.125rem] flex flex-col items-center justify-start py-[0rem] px-[1.25rem] box-border gap-[5rem_0rem] max-w-full text-left text-[1.5rem] text-midnightblue font-poppins lg:gap-[5rem_0rem] mq750:gap-[5rem_0rem]"
        >
          <div
            class="self-stretch flex flex-row items-center justify-between gap-[1.25rem] max-w-full mq750:flex-wrap"
          >
            <div
              class="flex flex-row items-center justify-start gap-[0rem_0.344rem]"
            >
              <h2
                class="m-0 h-[2.25rem] relative text-inherit tracking-[0.02em] font-semibold font-inherit flex items-center mq450:text-[1.188rem]"
              >
                Projects
              </h2>
              <img
            ...
            <div
              class="flex flex-row items-start justify-start gap-[0rem_1.375rem] max-w-full text-right text-[0.75rem] mq450:flex-wrap"
            >
           
              <div
                class="flex flex-row items-start justify-start gap-[0rem_0.25rem]"
              >
                <div
                  class="rounded-lg bg-white flex flex-row items-center justify-start py-[0.25rem] pr-[0.625rem] pl-[0.5rem] gap-[0rem_0.375rem]"
                >
                  <img
                ...
                <div
                  class="rounded-lg bg-white flex flex-row items-center justify-start p-[0.25rem]"
                >
                  <img
                    class="h-[1.313rem] w-[1.313rem] relative"
                    alt=""
